...
const Footer = () => {
  return (
    <footer className="footer pt-20 bg-[#10375C] text-white font-open-sans mt-auto flex flex-col justify-between min-h-screen">
      <div class="container mx-auto max-w-[calc(100%-20rem)] w-max lg:max-w-[calc(100%-10rem)] ">
        <div class="grid grid-cols-1 lg:grid-cols-4">
          <div class="col-span-1">
            {/* <!-- Logo --> */}
            <a href="/">
              <div class="logo">
                <div class="text-white text-lg">ZenClass</div>
              </div>
            </a>
          ...
          <div class="col-span-1">
            <h3 class="footer__heading mb-5 text-white font-open-sans text-base font-semibold leading-[28px]">
              Support
            </h3>
            <ul class="footer__list text-[#A9B3BB] font-open-sans text-sm font-normal leading-[26px] space-y-1">
          ...
          <div class="col-span-1">
            ...
            <div class="footer__social flex items-center gap-4 mb-5">
              <a
                href="#"
                class="footer__social-btn w-8 h-8 text-blue-900 bg-white rounded-full flex items-center justify-center"
              >
            ...
            <h3 class="footer__heading mt-4 mb-5 font-semibold text-base leading-7">
              Subscribe
            </h3>

            <p class="footer__desc text-[#A9B3BB] font-open-sans text-sm font-normal leading-[26px]">
              Subscribe our newsletter for the latest update of Dental care
            </p>

            <form class="footer-form flex gap-3 mt-3" action="">
              <input
                class="footer-form__input w-48 h-12 px-4 outline-none rounded"
                type="email"
                name="email"
                id="email"
              ...
              />
              <button
                class="btn footer-form__submit min-w-28 h-12 px-3 rounded-md text-white bg-[#2E80CE] hover:bg-blue-500 transition duration-300"
                type="submit"
              >
                Subscribe
              </button>
        ...
        <div class="footer__copyright mt-20 border-t border-solid border-[#406181]">
          <p class="footer__copyright-text mt-4 pb-6 text-[#AAB3BA] font-open-sans text-sm font-normal leading-[26px] text-center">
